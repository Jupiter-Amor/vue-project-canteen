<template>
  <div class="admin-container">
        ...
        <el-table-column label="头像" width="100" align="center">
          <template v-slot="scope">
            <div v-if="scope.row.avatar" class="avatar-container">
              <img :src="scope.row.avatar" alt="" class="admin-avatar">
            </div>
          </template>
        </el-table-column>
    ...
    <!-- 编辑对话框 -->
    <el-dialog v-model="data.formVisible" :title="data.form.id ? '编辑管理员' : '新增管理员'" width="450px" class="admin-dialog" destroy-on-close>
      <el-form :model="data.form" label-width="100px" class="admin-form">
